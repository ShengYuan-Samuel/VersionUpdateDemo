...
import com.nistart.versionupdatedemo.updata.OnCheckUpdateListener;
import com.nistart.versionupdatedemo.updata.OnUpdateListener;
import com.nistart.versionupdatedemo.updata.UpdateManager;
import com.nistart.versionupdatedemo.utils.AppUtils;

import static com.nistart.versionupdatedemo.utils.ToastUtils.showToast;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_check_update:
                mUpdateManager.checkUpdate("http://192.168.199.217/version.txt", new OnCheckUpdateListener() {
                    @Override
                    public void onFindNewVersion(String versionName, String newVersionContent,String upDataUrl) {
    ...
    private void buildNewVersionDialog(String message) {
        AlertDialog dialog = new AlertDialog.Builder(this)
                ...
                .setPositiveButton("更新", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                        mUpdateManager.startToUpdate("http://www.apk.anzhi.com/data3/apk/201703/14/4636d7fce23c9460587d602b9dc20714_88002100.apk", mOnUpdateListener);
                    }
                })
    ...
    private OnUpdateListener mOnUpdateListener = new OnUpdateListener() {
        ...
        public void onApkDownloadFinish(String apkPath) {
            ...
            //mUpdateManager.installApk(apkPath);
            dismissProgressDialog();
